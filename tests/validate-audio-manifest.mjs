...
assert(Array.isArray(manifest.assets) && manifest.assets.length >= 4, 'Audio manifest must register ML01, ML02, QL01-B and QL01-C.');
...
console.log('✓ ML01, ML02, QL01-B and QL01-C production MP3 files exist at their runtime paths');
