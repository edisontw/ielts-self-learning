...
assert(runtime.includes('playListeningMedia') && runtime.includes('data-lab-depth-audio'), 'Depth runtime must connect Listening sets to the shared media layer.');
...
console.log('✓ 12 new Listening scripts are wired to the shared browser-voice practice fallback');
