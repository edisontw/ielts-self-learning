...
// Initial startup uses a finite three-pass sequence rather than a continuous
// observer/polling loop. This covers async base-app startup without scanning.
renderRepairRoute();
queueMicrotask(renderRepairRoute);
setTimeout(renderRepairRoute, 0);
