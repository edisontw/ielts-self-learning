...
function adaptiveState(){try{return JSON.parse(localStorage.getItem(ADAPTIVE_KEY)||'{}')}catch{return{}}}
function apply(){
  ...
  if (note) note.insertAdjacentHTML('beforebegin', html); else main.insertAdjacentHTML('beforeend', html);
}
